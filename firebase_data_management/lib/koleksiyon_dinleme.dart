...
class KoleksiyonDinleme extends StatefulWidget {
  const KoleksiyonDinleme({super.key});

  @override
  State<KoleksiyonDinleme> createState() => _KoleksiyonDinlemeState();
}

class _KoleksiyonDinlemeState extends State<KoleksiyonDinleme> {
